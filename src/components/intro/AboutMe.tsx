      ...
      <section>
        <div className="intro">
          <h1 className="name ff-serif-jose fs-600">
            My Name is
            <br />
            <span className="hover ff-serif-teko fs-700">BIKRANT MALLA.</span>
          </h1>
      ...
      <section id="aboutme">
        ...
        <div className="aboutme">
          <p className="ff-serif-jose fs-400">
            Hello! My name is Bikrant. I am a self-taught, passionate front-end
            developer from Nepal. My interest in front-end web development
            started in 2012. Before that, I had experience as a UI/UX designer.
            I completed my undergraduate degree in Bachelor of Computer
            Applications (BCA) from India.
          </p>
          <p className="ff-serif-jose fs-400">
            I have always wanted to create new things and explore new
            development tools. This has led me to a career in web development,
            which has changed a lot for me. I strive to push my work to new
            horizons with each project and prioritize quality. To learn more,
            please check my work and feel free to get in touch.
          </p>
        </div>
      </section>
      <section id="skill">
