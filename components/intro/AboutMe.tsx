      ...
      <section id="aboutme">
        ...
        {aboutMeData.aboutme.map((about, index) => (
          <div className="aboutme" key={index}>
            <p className="ff-serif-jose fs-400">{about.aboutDescription1}</p>
            <p className="ff-serif-jose fs-400">{about.aboutDescription2}</p>
          </div>
        ))}
      </section>
      <section id="skill">
            ...
            <div key={index} className="techstack">
              <div className="list">
                ...
                {skill.skill1.map((tech, index) => (
                  <p className="ff-serif-jose fs-400" key={index}>
                    {tech}
                  </p>
                ))}
              </div>
